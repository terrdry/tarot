...
class Card(db.Model):
    ...
    readings_relation = db.relationship("Readcard", back_populates='cards_relation')
...
class Reading(db.Model):
    ...
    cards_relation = db.relationship("Readcard", back_populates="readings_relation")
...
class Readcard(db.Model):
    ...
    cards_relation = db.relationship("Card", back_populates='readings_relation')
    readings_relation = db.relationship("Reading", back_populates='cards_relation')
